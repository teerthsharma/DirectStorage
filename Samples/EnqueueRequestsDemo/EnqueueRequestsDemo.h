...
class EnqueueRequestsDemo : public DXSample
{
public:
    EnqueueRequestsDemo(UINT width, UINT height, std::wstring name);
...
private:
    ...
    ComPtr<IDStorageQueue3> m_dsQueue;
    ComPtr<ID3D12Fence> m_dsUTMCompletedFence;
    ComPtr<ID3D12Fence> m_dsRequestsCompletedFence;
    UINT64 m_dsUTMCompletedFenceValue;
    UINT64 m_dsRequestsCompletedFenceValue;
    std::vector<std::vector<UINT8>> m_dsConditionedMipData;
